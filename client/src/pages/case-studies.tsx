...
import { Clock, MapPin, DollarSign, Zap, Users, ArrowRight } from "lucide-react";
      ...
      <section className="relative py-20 bg-gradient-to-br from-grid-dark-blue to-grid-blue">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Explore how Grid Flow delivers exceptional results for clients across diverse industries with innovative power engineering solutions.
          </p>
        </div>
      </section>
